...
typedef struct renderGraphResourcePassRecord_s {
	...
	int						resolveOps;
	int						invalidateOps;
	int						invalidateCandidates;
	int						invalidateSkipped;
	int						invalidateSubmitted;
	int						presentOps;
	bool					enabled;
	bool					legacyWrapped;
...
typedef struct renderGraphResourceManagerStats_s {
	...
	int						skippedBuffers;
	int						aliasGroups;
	bool					invalidateEnabled;
	int						invalidateTaggedAccesses;
	int						invalidateCandidates;
	int						invalidateArmedCandidates;
	int						invalidateSubmitted;
	int						invalidateSkipped;
	int						invalidateSkippedUnavailable;
	int						invalidateSkippedInvalidResource;
	int						invalidateSkippedImported;
	int						invalidateSkippedBuffer;
	int						invalidateSkippedNonTransient;
	int						invalidateSkippedPresentable;
