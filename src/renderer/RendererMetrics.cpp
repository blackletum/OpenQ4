...
void R_RendererMetrics_EndFrame( int frontEndMsec, int backEndMsec, int viewCount, int visibleEntities, int viewLights, int drawElements, int surfaces, int vertexes, int indexes ) {
	...
	if ( detail >= 2 ) {
		...
		common->Printf(
			...
			rg_rendererMetrics.renderGraphResourceManager.invalidateEnabled ? 1 : 0,
			rg_rendererMetrics.renderGraphResourceManager.invalidateTaggedAccesses,
			rg_rendererMetrics.renderGraphResourceManager.invalidateCandidates,
			rg_rendererMetrics.renderGraphResourceManager.invalidateArmedCandidates,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitted,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkipped,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedUnavailable,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedInvalidResource,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedImported,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedBuffer,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedNonTransient,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedPresentable,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedNotLastUse,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedIncompleteFramebuffer,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSkippedUnsupportedAttachment,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitSkippedDisabled,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitSkippedUnsupportedTier,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitSkippedMissingOwner,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitSkippedMissingFramebuffer,
			rg_rendererMetrics.renderGraphResourceManager.invalidateSubmitSkippedUnsubmittedPass,
