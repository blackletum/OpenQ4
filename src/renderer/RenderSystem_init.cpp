...
void R_ReadTiledPixels( int width, int height, byte *buffer, renderView_t *ref = NULL ) {
	...
	const bool overrideScissor = !r_screenshotKeepScissor.GetBool() && ( width > oldWidth || height > oldHeight );
	if ( overrideScissor ) {
