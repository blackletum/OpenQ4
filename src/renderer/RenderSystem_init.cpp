...
idCVar r_shadowMapSubviewPolicy( "r_shadowMapSubviewPolicy", "1", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "shadow maps in mirror/remote subviews: 0 = render like main views, 1 = reuse cached maps or fall back to stencil (never render fresh maps), 2 = always stencil", 0, 2, idCmdSystem::ArgCompletion_Integer<0,2> );
...
idCVar r_lightGridResidencyFrames( "r_lightGridResidencyFrames", "0", CVAR_RENDERER | CVAR_ARCHIVE | CVAR_INTEGER, "frames to keep loose fallback light-grid atlases resident after visible/neighbor use; 0 disables runtime purging and packed grids always stay resident", 0, 3600, idCmdSystem::ArgCompletion_Integer<0,3600> );
