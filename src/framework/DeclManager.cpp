...
void idDeclLocal::ParseLocal( bool noCaching ) {
	...
	// as _ttfatlasx_; retained output-size pages use _ttfatlasr_. All exist
	// only after runtime rasterization.
	const bool generatedRetainedResource = type == DECL_MATERIAL && generatedDefaultText && IsImplicit() &&
		( name.Icmp("_retainedsolid") == 0 || name.Icmpn("_retained/_ttfatlas_",20) == 0 || name.Icmpn("_retained/_ttfatlasx_",21) == 0 || name.Icmpn("_retained/_ttfatlasr_",21) == 0 || name.Icmpn("_retainedLayer/",15) == 0 || name.Icmpn("_retainedMask/",14) == 0 );
