...
def main():
    ...
    try:
        for name,body,mutant in cases:
            ...
            if name.startswith('interaction'):command[-2:-2]=[str(ROOT/'src/ui/retained'/n) for n in ('Interaction.cpp','ScrollGeometry.cpp','NativeTextDocument.cpp','NativeTextEditor.cpp')]
