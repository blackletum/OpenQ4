...
def validate_linux_sdl3_x11_helpers_are_optional() -> None:
    ...
    require(linux_sdl3, "SDL_GetCurrentDisplayMode(display)", "SDL3 Linux desktop resolution current-mode fallback")
    require(linux_sdl3, "SDL_GetDisplayBounds(display, &bounds)", "SDL3 Linux desktop resolution bounds fallback")
    require(linux_sdl3, "desktop display mode unavailable", "SDL3 Linux desktop resolution fallback log")
