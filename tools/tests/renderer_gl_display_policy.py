...
enum {RENDERER_PRESENT_WINDOW_STATE,RENDERER_PRESENT_CONTEXT,RENDERER_PRESENT_SWAP};
...
static bool R_ImagePolicyContentMutation(){return true;}
...
struct idImage {
    ...
    bool IsFileBacked()const{return false;}
