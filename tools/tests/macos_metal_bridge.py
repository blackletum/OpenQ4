...
def validate_packaging_and_release_contract() -> None:
    ...
    require(release, "macos_release_enabled", "manual release credential-aware macOS matrix")
    require(release, "macOS release artifacts skipped because Apple signing/notary", "manual release macOS credential fallback")
...
def validate_docs_and_ci_hooks() -> None:
    ...
    require(building, "Official macOS release artifacts are published only when Apple Developer ID signing and notarization credentials are configured", "macOS release credential policy documentation")
    require(building, "When they are published, they are Apple Silicon/arm64 only", "macOS architecture policy documentation")
    ...
    require(getting_started, "macOS packages are published only from credentialed release runs", "getting started macOS credential policy")
    require(getting_started, "When macOS packages are published, they are for Apple Silicon/arm64 Macs", "getting started macOS architecture policy")
    ...
    require(package_readme, "macOS packages are published only from credentialed release runs", "release package macOS credential policy")
    require(package_readme, "When macOS packages are published, they are for Apple Silicon/arm64 Macs", "release package macOS architecture policy")
    ...
    require(platform_support, "Official macOS release artifacts are published only when Apple Developer ID signing and notarization credentials are configured", "platform support macOS credential policy")
    require(platform_support, "When published, they are Apple Silicon/arm64 only", "platform support macOS architecture policy")
