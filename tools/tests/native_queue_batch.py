...
# Exact public include closure for SDL_events.h and SDL_init.h in pinned 3.4.16.
...
def main():
    ...
    assert specification['directory']=='SDL3-3.4.16','Review SDL header whitelist before updating the pinned release'
