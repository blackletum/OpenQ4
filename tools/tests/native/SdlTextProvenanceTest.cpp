...
static bool SDL_GetHintBoolean(const char*,bool fallback){return fallback;}
static size_t SDL_strlen(const char* text){return std::strlen(text);}
#define SDL_arraysize(a) (sizeof(a)/sizeof((a)[0]))
static size_t SDL_utf8strlcpy(char*,const char*,size_t){throw std::runtime_error("unexpected SDL2 compatibility mode");}
