...
enum textureFormat_t{FMT_NONE,FMT_DXT1,FMT_DXT5,FMT_BC7,FMT_RGBA8,FMT_SRGBA8,FMT_OTHER,FMT_ETC2_RGB8,FMT_ETC2_RGBA8,FMT_EAC_RG11,FMT_LUM8,FMT_INT8,FMT_ALPHA,FMT_L8A8,FMT_RGB565};
...
static void Cubes(){
 ...
 byte px[4]{};TEST(!R_ShrinkLoadedImageData(px,1,1,0,0,false,false));TEST(!R_ShrinkLoadedImageData(px,1,1,2,2,false,false));
...
static void Assembly(){
 for(int width:{1,2,3,7,8,15})for(auto format:{FMT_DXT1,FMT_DXT5,FMT_RGBA8,FMT_SRGBA8,FMT_OTHER})for(bool gamma:{false,true}){
...
static void Assembly2D(){
 for(auto format:{FMT_DXT1,FMT_DXT5,FMT_SRGBA8,FMT_ETC2_RGB8,FMT_ETC2_RGBA8,FMT_EAC_RG11,FMT_LUM8,FMT_INT8,FMT_ALPHA,FMT_L8A8,FMT_RGB565,FMT_OTHER})for(auto color:{CFM_DEFAULT,CFM_NORMAL_DXT5,CFM_YCOCG_DXT5,CFM_GREEN_ALPHA}){
...
def main():
 ...
 names.append('src/imagetools/SRGB.h')
 ...
 cpu+='\n#include "SRGB.h"\n'+'\n'.join(method(process,s) for s in ['byte *R_MipMapWithSRGB(', 'byte * R_MipMapWithGamma(', 'byte * R_MipMap(', 'void R_ApplyFilterNeutralAlpha('])
