...
struct idCVarCompletionSnapshot {void Restore(){}void Clear(){}};
struct Module {bool interfacesPublished=true,moduleExportValid=true;renderExport_t moduleExport{};intptr_t moduleHandle=1;rendererModuleStatus_t status{};idCVarCompletionSnapshot moduleCompletions;} rm_state;
...
def main():
 ...
 try:
  ...
  body=SUPPORT+globals+method(src,'static void RM_UnloadModuleBinary(')+method(src,'static bool RM_UnloadModule(')+method(src,'void R_RendererModule_Shutdown(')
