...
build_setup_args_for_existing_build_dir() {
    ...
    local option_name=""
    local option_value=""
    for option_name in platform_backend macos_graphics_bridge version_track version_iteration version_base_override openal_root_override use_pch build_engine build_games build_game_sp build_game_mp enforce_msvc_2026; do
