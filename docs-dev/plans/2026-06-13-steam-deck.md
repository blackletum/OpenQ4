...
| `content/baseoq4/default.cfg` | Stock gamepad/Deck-adjacent bindings | Missing native gyro/touchpad path |
...
**Code locations.** `src/sys/sdl3/sdl3_backend.cpp:L2439-L2488,L3746-L3871`, `content/baseoq4/default.cfg:L645-L706`, `docs-user/steam-deck.md:L254-L283`, `docs-user/input-settings.md:L317-L325,L395-L408,L462-L480`. citeturn22view0turn26view1turn37view0turn37view5turn37view6turn31view0turn31view3turn50view0turn30view6turn30view7
...
**Code locations.** `content/baseoq4/openq4_profile_steamdeck.cfg:L260-L272`, `src/framework/Common.cpp` entry where `com_maxfps` defaults to `240` in the reviewed source, `src/sys/sdl3/sdl3_backend.cpp:L2486-L2491` for rumble/display cvars, plus the absence of battery power integration in the SDL3 backend review. citeturn31view4turn31view5turn33view1turn37view0turn37view1turn21view5turn24view15
