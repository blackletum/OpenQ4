...
3. Validate macOS SDL3 keyboard/edit-field behavior, controller hotplug/rumble, multi-button mouse, and trackpad scrolling on hardware; then repeat the native Cocoa fallback keyboard/mouse smoke pass.
