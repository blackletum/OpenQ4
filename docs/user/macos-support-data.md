...
- Whether you launched `openQ4.app`, `openQ4-client_arm64` from Terminal, or
  both.
...
If the app crashes, attach `~/Desktop/openq4-terminal.txt` or paste its full
contents into the issue.
